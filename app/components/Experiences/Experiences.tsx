...
const Experiences = () => {
  return <SectionContainer id='experience'>
    ...
    <div className='circle-icon h-14 w-14 top-[77px] right-1.5
    md:top-[153px] md:right-[90px] -z-10'>
        <Image
    ...
    <div className='circle-icon h-14 w-14 left-1.5 bottom-0
    md:left-[90px] -z-10'>
        <Image
