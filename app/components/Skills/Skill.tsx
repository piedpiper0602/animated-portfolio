...
const Skill = ({icon, name}: Props) => {
  ...
  const mask = useMotionTemplate`radial-gradient(100px 100px 
  at ${xDistance}px ${yDistance}px, #000, transparent)`
  ...
  return (
    <Reveal duration={1.5}>
    <div className='relative flex gap-2 p-2 border-primary border 
    rounded-lg h-[46px]'>
      <motion.div 
      ref={ref}
