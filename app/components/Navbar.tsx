...
const Navbar = () => {
  ...
  return (
    ...
    md:right-auto md:top-4 md:left-1/2 md:-translate-x-1/2">
      ...
      <Reveal initialY={-20} duration={0.5}>
        ...
        >
          <ul className="flex flex-col items-center gap-4 text-lg font-formal md:flex-row">
            <li>
              <div
            ...
            <li>
              <div
                className={cn("rounded p-1 whitespace-nowrap duration-300 ease-in-out", { "bg-primary text-white": activeSection === "contact" })}
