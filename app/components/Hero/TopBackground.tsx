...
const TopBackground = () => {
  ...
  h-[285px] md:h-[656px] top-[188px] md:top-11 left-1/2 -translate-x-1/2
  md:overflow-x-hidden z-10">
    <div className='w-full h-full relative'>
        <div className='circle-icon top-8 left-[171px] md:top-28 md:left-72'>
  ...
  <img 
    ...
    />
  <div className='absolute top-0 w-full h-[795px] bg-repeat-x bg-[url("/top_bg_light.svg")]
    bg-[auto_auto] hidden dark:hidden md:block' />
  <div className='absolute top-0 w-full h-[600px] bg-repeat-x bg-[url("/top_bg_mobile_light.svg")]
    bg-[auto_auto] dark:hidden md:hidden' />
  <div className='absolute top-0 w-full h-[795px] bg-repeat-x bg-[url("/top_bg_dark.svg")]
    bg-[auto_auto] hidden md:dark:block' />
  <div className='absolute top-0 w-full h-[600px] bg-repeat-x bg-[url("/top_bg_mobile_dark.svg")]
    bg-[auto_auto] hidden dark:block dark:md:hidden' />
  </>
}
